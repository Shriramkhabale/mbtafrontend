            ...
            <div style={{ border: '1.8px solid #000', padding: '6px', boxSizing: 'border-box' }}>
              ...
              <div style={{ borderTop: '1.2px solid #000', paddingTop: '4px', marginBottom: '6px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                  <span style={{ fontWeight: 'bold', fontSize: '10px' }}>5 Date of Birth / Incorporation / Agreement / Partnership</span>
              ...
              <div style={{ borderTop: '1.2px solid #000', paddingTop: '4px', marginBottom: '6px' }}>
                ...
                <div style={{ fontWeight: 'bold', fontSize: '9px', marginBottom: '2px' }}>Father's Name (Mandatory except where mother is single parent)</div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', marginBottom: '4px' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '150px 1fr', alignItems: 'center' }}>
                    <span style={{ fontSize: '9px' }}>Last Name / Surname</span>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '150px 1fr', alignItems: 'center' }}>
                    <span style={{ fontSize: '9px' }}>First Name</span>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '150px 1fr', alignItems: 'center' }}>
                    <span style={{ fontSize: '9px' }}>Middle Name</span>
                ...
                <div style={{ fontWeight: 'bold', fontSize: '9px', marginBottom: '2px' }}>Mother's Name (Optional)</div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', marginBottom: '4px' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '150px 1fr', alignItems: 'center' }}>
                    <span style={{ fontSize: '9px' }}>Last Name / Surname</span>
